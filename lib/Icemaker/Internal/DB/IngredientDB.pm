package Icemaker::Internal::DB::IngredientDB;

use Poet qw($conf);
use Moose;

use constant METHODS => (qw/id name status in_stock creation_date last_updated_date/);
...
sub new {
    ...
    $self->_db($conf->get('db.ingredient_db'));
