package Icemaker::Internal::DB::UserDB;

use Poet qw($conf);
use Moose;

use constant METHODS => (qw/id name username password status creation_date last_updated_date/);
